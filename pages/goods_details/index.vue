    ...
    >
      ...
      <view>
        ...
        >
          <view id="past0">
            ...
            <view class="wrapper">
              <view class="share acea-row row-between row-bottom">
                ...
                <view
                  class="iconfont icon-fenxiang skeleton-rect"
              ...
              >
                <view
                  class="skeleton-rect"
                  v-text="'原价:￥' + (storeInfo.ot_price || 0)"
                ></view>
                <view
                  class="skeleton-rect"
                  v-text="
            ...
            >
              ...
              <view
                ...
                style="margin-top: 7px; padding-left: 60px"
          ...
          <view
            class="userEvaluation skeleton-rect"
            id="past1"
            v-if="replyCount"
          >
      ...
      <view class="footer acea-row row-between-wrapper">
        ...
        <view>
          <view
            class="bnt acea-row"
            :class="storeInfo.is_virtual ? 'virbnt' : ''"
            v-if="attr.productSelect.stock <= 0"
          >
            <form
              v-if="!storeInfo.is_virtual"
              @submit="joinCart"
              class="joinCart bnts"
              :class="storeInfo.is_virtual ? 'virbnt' : ''"
            >
      ...
      <view class="share-box" v-if="H5ShareBox">
        <image
          src="/static/images/share-info.png"
